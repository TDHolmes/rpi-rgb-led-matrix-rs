...
#[repr(C)]
pub struct RGBLedMatrix { _private: [u8; 0] }

#[repr(C)]
pub struct LedCanvas { _private: [u8; 0] }

#[repr(C)]
pub struct LedFont { _private: [u8; 0] }
...
pub struct RGBLedMatrixOptions {
    ...
    */
    pub various_bitfield_options: u8
...
extern {
    ...
    pub fn led_matrix_create_from_options(options: *mut RGBLedMatrixOptions, argc: *const c_int, argv_unused: *const c_char) -> *mut RGBLedMatrix;
    ...
    pub fn led_matrix_swap_on_vsync(matrix: *mut RGBLedMatrix, canvas: *mut LedCanvas) -> *mut LedCanvas;
    ...
    pub fn draw_line(c: *mut LedCanvas, x0: c_int, y0: c_int, x1: c_int, y1: c_int, r: u8, g: u8, b: u8);
